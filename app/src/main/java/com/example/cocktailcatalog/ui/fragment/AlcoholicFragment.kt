...
import com.example.cocktailcatalog.databinding.FragmentAlcoholicBinding
...
class AlcoholicFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        adapter = CocktailAdapter { cocktail ->
            val action = AlcoholicFragmentDirections.actionAlcoholicFragmentToCocktailDetailFragment(cocktail.id)
