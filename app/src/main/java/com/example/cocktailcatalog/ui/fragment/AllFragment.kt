...
import com.example.cocktailcatalog.databinding.FragmentAllBinding
...
class AllFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        adapter = CocktailAdapter { cocktail ->
            val action = AllFragmentDirections.actionAllFragmentToCocktailDetailFragment(cocktail.id)
